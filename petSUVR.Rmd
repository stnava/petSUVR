...
txc2mni = c( temwrp, temaff )
mni2txc = c( temaff, itemwrp )
malf2sub = antsApplyTransforms( t1img, malf, transformlist = mni2txc, interpolator="NearestNeighbor" )
